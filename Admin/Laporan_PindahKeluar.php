...
<body bgcolor="#FFFFFF">
	...
	<center>
		<font color='#033500' face='Tahoma' size=5><b><br>LAPORAN PENGAJUAN PINDAH KELUAR</b></font><br><br>
		...
		<table border="0" cellpadding="2" cellspacing="2" bordercolor="blue" bgcolor="white" width="100%">
			<tr bgcolor='#363636' height="30"><font color='white'>
				...
				<th align='center'><font color='white' face='Tahoma' size=2 width=10%>Status No KK</font></th>
			...
			<tr>
				...
				<td align='left' bgcolor='#ededed'><font face='Arial' size=2 width=20%><?php echo $row["status_no_kk"];?></font></td>
			...
			<tr>
				<td align="right" colspan="20" bgcolor='#8f9779'>
					<input type="button" name="kembali" value="Kembali" onclick="parent.location='FrmHome.php?page=Laporan_PindahKeluar.php'">
					<input type="button" name="cetak" value="Cetak Laporan" onclick="window.open('Cetak_PindahKeluar.php?date1=<?php echo $vTanggal1;?>&date2=<?php echo $vTanggal2;?>')" >
				</td>
			</tr>
		</table>
	</center>
