...
<body bgcolor="#FFFFFF">
	<?php  
		...
		$query=mysqli_query($connection, "SELECT * FROM tbl_surat_kematian order by nik Asc")or die (mysql_error());
		$jumlah = mysqli_num_rows($query);
	?>
	<center>
		<font color='#033500' face='Tahoma' size=5><b><br>PENGAJUAN AKTA KEMATIAN</b></font><br>
...
\				<th align='center'><font color='white' face='Tahoma' size=2 width=20%>Alamat</font></th>
			...
			<tr>
				...
				<td align='center' bgcolor='#ededed' width=8%>
					<a href="FrmHome.php?page=FrmTampilSuratKematian.php&Kode=<?php echo $row['nik']?>" style="text-decoration:none" title="View"><font color='#3c2e3d' face='tahoma' size='2'>[ View ]</font>
					</a>
				</td>
			</tr>
			<?php
